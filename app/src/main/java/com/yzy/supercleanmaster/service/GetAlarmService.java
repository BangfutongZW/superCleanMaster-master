...
public class GetAlarmService extends Service {
    ...
    public class CleanerServiceBinder extends Binder {
        ...
        public GetAlarmService getService() {
            return GetAlarmService.this;
        }
    }
    ...
    private class TaskScan extends AsyncTask<Void, Integer, List<CacheListItem>> {
        ...
        protected void onPreExecute() {
            if (mOnActionListener != null) {
                mOnActionListener.onScanStarted(GetAlarmService.this);
            }
        }
        ...
        protected void onProgressUpdate(Integer... values) {
            if (mOnActionListener != null) {
                mOnActionListener.onScanProgressUpdated(GetAlarmService.this, values[0], values[1]);
            }
        }
        ...
        protected void onPostExecute(List<CacheListItem> result) {
            if (mOnActionListener != null) {
                mOnActionListener.onScanCompleted(GetAlarmService.this, result);
            }
    ...
    private class TaskClean extends AsyncTask<Void, Void, Long> {
        ...
        protected void onPreExecute() {
            if (mOnActionListener != null) {
                mOnActionListener.onCleanStarted(GetAlarmService.this);
            }
        }
        ...
        protected void onPostExecute(Long result) {
            ...
            if (mOnActionListener != null) {
                mOnActionListener.onCleanCompleted(GetAlarmService.this, result);
            }
                ...
                setOnActionListener(new OnActionListener() {
                    ...
                    public void onCleanCompleted(Context context, long cacheSize) {
                        String msg = getString(R.string.cleaned, Formatter.formatShortFileSize(
                                GetAlarmService.this, cacheSize));

                        Log.d(TAG, msg);

                        Toast.makeText(GetAlarmService.this, msg, Toast.LENGTH_LONG).show();
